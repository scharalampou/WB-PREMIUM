                ...
                {Array.from({ length: intermediateStepCount }).map((_, i) => {
                    ...
                    return (
                        <div
                            ...
                            style={{ 
                                left: stepPosition,
                                backgroundColor: isFilled ? '#129263' : '#D6D8D5',
                             }}
                        >
                            <Droplets className={cn("size-5", isFilled ? "text-white" : "text-[#999999]")} />
                        </div>
                    );
                })}

                {/* Final Flower Step */}
                <div className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center" style={{ left: '100%' }}>
            ...
            <div className="space-y-6">
                ...
                <Card className="flex flex-col">
                    ...
                    <CardContent className="flex-grow flex flex-col p-0 bg-accent/10 rounded-b-lg border-2 border-dashed border-accent/30 dark:bg-card/70">
                         <div className="bg-grass bg-bottom bg-no-repeat [background-size:100%_auto] flex-grow flex flex-col items-center justify-center p-4 md:p-6 pb-16">
